                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title">Cập nhật nhà cung cấp </h2>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="name" class="form-control" id="product-title" value="{{ $supplier->name }}">
                                        </div>
                                        @error('name')
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="email" class="form-control" id="product-description" value="{{ $supplier->email }}">
                                        </div>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="phone" class="form-control" id="product-description" value="{{ $supplier->phone }}">
                                        </div>
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="address" class="form-control" id="product-description" value="{{ $supplier->address }}">
                                        </div>
                                        @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
