          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="footer-widget footer-about mb-40">
                <div class="footer-logo">
                  <a href="index.html"
                    ><img src="{{ asset('images/avatar/logo-ducviet.png') }}" alt="logo"
                  /></a>
                </div>
                <p>
                    Công Ty Cổ Phần Dịch Vụ Thương Mại Tổng Hợp Ducviet Foods
                </p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              ...
              >
                ...
                <ul>
                  <li><a target="_blank" href="{{ route('about') }}">Giới thiệu về Ducviet Foods</a></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
              ...
              >
                ...
                <ul>
                  ...
                  <li>Email: <a href="mailto:cskh@winmart.masangroup.com">cskh@ducviet-foods.masangroup.com</a></li>
